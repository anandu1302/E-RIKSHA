...
import com.nextgen.eriksha.Adapter.AccountAdapter;
import com.nextgen.eriksha.ModelClass.AccountModelClass;
...
public class AccountDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountLL = findViewById(R.id.addAccountLL);
        ...
        backIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent bIntent = new Intent(AccountDetailsActivity.this,UserDashboardActivity.class);
